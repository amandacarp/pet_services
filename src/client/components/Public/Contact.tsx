...
const Contact = (props: RegisterProps) => {
    ...
    return (
        <>
            ...
            <h1 className="flex justify-center text-2xl font-bold text-indigo-300 border border-indigo-300 mt-14">Contact Me</h1>
            <div className="flex flex-wrap justify-center mt-10 overflow-hidden">
                <form className="w-11/12 px-5 py-5 mx-5 my-5 overflow-hidden bg-gray-300 border border-indigo-300 rounded shadow lg:w-1/4">
                    ...
                    <div className="mt-5 text-center md:px-2 md:py-2"><button onClick={handleSubmit} className="inline-block px-4 py-2 mt-4 text-sm leading-none text-indigo-400 border border-indigo-400 rounded hover:border-transparent hover:text-indigo-500 hover:bg-white md:mt-0">Send Email</button></div>
