...
const insert = (userid: User['id'], description: Event['description'], time: Event['time'], start_date: Event['start_date'], end_date: Event['end_date'], petid: Pet['id'], serviceid: Services['id']) => Query<MySQLResponse>('INSERT INTO Events SET userid = ?, description = ?, time = ?, start_date = ?, end_date = ?, petid = ?, serviceid = ?', [userid, description, time, start_date, end_date, petid, serviceid]);
const update = (description: Event['description'], time: Event['time'], start_date: Event['start_date'], end_date: Event['end_date'], petid: Pet['id'], serviceid: Services['id'], id: Event['id'], userid: User['id']) => Query<MySQLResponse>('UPDATE Events SET description = ?, time = ?, start_date = ?, end_date = ?, petid = ?, serviceid = ? WHERE id = ? AND userid = ?',  [description, time, start_date, end_date, petid, serviceid, id, userid]);
