...
export const sendEmail = (to: string, from: string, subject: string, content: string) => { //give utility function to streamline process in our route
    const data = {
        to,
        from,
        subject,
...
export const sendConfirm = (to: string, from: string, subject:string, content: string) => { //give utility function to streamline process in our route
    const data = {
        to,
        from,
        subject,
...
//give us ability to use function in our route if required
